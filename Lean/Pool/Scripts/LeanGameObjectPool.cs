...
namespace Lean.Pool
{
    ...
    public class LeanGameObjectPool : MonoBehaviour, ISerializationCallbackReceiver
    {
        ...
        /// <summary>This stores all spawned clones in a hash set. This is used when Recycle is disabled, because their SpinningSword order isn't important. This allows us to quickly find the Clone associated with the specified GameObject.</summary>
