...
* **Breaking changes**
  ...
  * Changed `.skel` binary format, added a string table. References to strings in the data resolve to this string table, reducing SpinningSword size of binary files considerably.
